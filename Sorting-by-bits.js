/*
In this challenge, you're expected to sort an array of 32-bit 
...
but the integer 10 is less than 12,
so it comes first in sorted order.

Your task is to write a function that takes an 
array of integers and sort them as described above.
